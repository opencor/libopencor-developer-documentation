...
- `libSEDML <https://github.com/fbergmann/libSEDML/>`__ 2.0.28: a library for reading and writing `SED-ML <https://sed-ml.github.io/>`__ files.
...
- `OpenSSL <https://openssl.org/>`__ 3.0.1: a toolkit implementing the Secure Sockets Layer (SSL v2/v3) and Transport Layer Security (TLS) protocols, as well as a full-strength general purpose cryptography library.
