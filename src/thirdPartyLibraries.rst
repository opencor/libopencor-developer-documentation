...
- `libcurl <https://curl.se/libcurl/>`__ 8.13.0: the multiprotocol file transfer library.
...
- `libNuML <https://github.com/NuML/NuML>`__ 1.1.7: a library for reading and writing `NuML <https://github.com/NuML/NuML>`__ models.
...
- `libSBML <https://github.com/sbmlteam/libsbml>`__ 5.20.5: a programming library to help you read, write, manipulate, translate and validate `SBML <https://sbml.org/>`__ files and data streams.
...
- `libSEDML <https://github.com/fbergmann/libSEDML>`__ 2.0.33: a library for reading and writing `SED-ML <https://sed-ml.github.io/>`__ files.
...
- `libssh2 <https://libssh2.org/>`__ 1.11.1: a client-side C library implementing the `SSH2 <https://en.wikipedia.org/wiki/Secure_Shell>`__ protocol.
...
- `LLVM <https://llvm.org/>`__\ +\ `Clang <https://clang.llvm.org/>`__ 16.0.6: a collection of modular and reusable compiler and toolchain technologies.
